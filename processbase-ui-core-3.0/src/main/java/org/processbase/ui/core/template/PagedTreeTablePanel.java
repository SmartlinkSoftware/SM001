...
public abstract class PagedTreeTablePanel extends WorkPanel implements
		Window.CloseListener, Window.ResizeListener {

	/** Serial version UID. */
	private static final long serialVersionUID = -5018346478710771696L;
	...
	public void refreshTable() {
		if(maxResults <= 25){
			treeTable.setPageLength(maxResults);
		}else{
			treeTable.setPageLength(25);
		}
		int results = load(startPosition, maxResults);
