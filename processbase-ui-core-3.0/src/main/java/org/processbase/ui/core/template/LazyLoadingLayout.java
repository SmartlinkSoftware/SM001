 ...
 * @author dll
 */
public class LazyLoadingLayout  extends VerticalLayout implements Runnable
{
     ...
     */
    public LazyLoadingLayout ( LazyLoader loader, boolean loadImmideately )
    {
        this.loader = loader;
        initUI ();
    ...
    {
        activateLoadingView ();
        ProcessbaseApplication.getCurrent().invokeLater ( this );
    }
...
*/
  ...
  //      setExpandRatio ( sz2, 0.5f );
    ...
    public interface LazyLoader
    {
         ...
         */
        Component lazyLoad ( LazyLoadingLayout layout );
    }
}