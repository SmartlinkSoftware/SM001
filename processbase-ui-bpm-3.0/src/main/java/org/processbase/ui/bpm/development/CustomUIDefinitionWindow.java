 ...
 * @author mgubaidullin
 */
public class CustomUIDefinitionWindow extends PbWindow implements ClickListener, TabSheet.SelectedTabChangeListener {
    ...
    public CustomUIDefinitionWindow(String fileName) {
        super(fileName);
...
//            }
//
//            tabSheet.addTab(v1, ProcessbaseApplication.getCurrent().getMessages().getString("tabDescription"), null);
//
...
//            v2.setSizeFull();
//            tabSheet.addTab(v2, ProcessbaseApplication.getCurrent().getMessages().getString("tabCustomUI"), null);
//
//            // prepare membership
//            prepareTableMembership();
//            addBtn = new Button(ProcessbaseApplication.getCurrent().getMessages().getString("btnAdd"), this);
...
//            v3.setSizeFull();
//            tabSheet.addTab(v3, ProcessbaseApplication.getCurrent().getMessages().getString("processAccess"), null);
...
//
//            closeBtn = new Button(ProcessbaseApplication.getCurrent().getMessages().getString("btnClose"), this);
//            applyBtn = new Button(ProcessbaseApplication.getCurrent().getMessages().getString("btnSaveCustomUI"), this);
//            saveAccessBtn = new Button(ProcessbaseApplication.getCurrent().getMessages().getString("btnSaveProcessAccess"), this);
//            deleteAllBtn = new Button(ProcessbaseApplication.getCurrent().getMessages().getString("btnDeleteAll"), this);
//            deleteInstancesBtn = new Button(ProcessbaseApplication.getCurrent().getMessages().getString("btnDeleteInstances"), this);
//            downloadBtn = new Button(ProcessbaseApplication.getCurrent().getMessages().getString("btnDownload"), this);
//            enableBtn = new CheckBox(ProcessbaseApplication.getCurrent().getMessages().getString("btnEnable"), this);
//            archiveBtn = new Button(ProcessbaseApplication.getCurrent().getMessages().getString("btnArchive"), this);
//
//            deleteAllBtn.setDescription(ProcessbaseApplication.getCurrent().getMessages().getString("deleteProcessDefinition"));
//            buttons.addButton(deleteAllBtn);
//            buttons.setComponentAlignment(deleteAllBtn, Alignment.MIDDLE_RIGHT);
//            deleteInstancesBtn.setDescription(ProcessbaseApplication.getCurrent().getMessages().getString("deleteProcessInstances"));
