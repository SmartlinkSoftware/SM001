 ...
 * @since 1.0.0
 */
public class CustomServiceTemplate extends CustomWebServiceAccessor implements WebServiceOperations {
     ...
     */
    public CustomServiceTemplate(WebServiceMessageFactory messageFactory) {
    ...
    protected void initDefaultStrategies() {
        Resource resource = new ClassPathResource(ClassUtils.getShortName(CustomServiceTemplate.class) + ".properties",
                CustomServiceTemplate.class);
