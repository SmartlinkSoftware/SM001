 ...
 */
public class CustomXTeeConsumerMessageExtractor implements WebServiceMessageExtractor {
  private final XmlBeansXTeeMetadata metadata;

  public CustomXTeeConsumerMessageExtractor(XmlBeansXTeeMetadata metadata) {
